...
<div class="w3-container w3-center w3-margin-bottom w3-padding">
    <div class="w3-card-4">
        <div class="w3-card-4">
            ...
            <form method="get" class="w3-selection w3-light-grey w3-padding">
                <label>Name:
                    <input type="text" name="name" class="w3-input w3-input w3-border w3-round-large"
                           style="width: 30%"><br/>
                </label>
        ...
        <%
            ...
            if (name != null && !name.isEmpty()) {
                ...
                out.println("</ul>");
                System.out.println("Mame from get.jsp: " + name);
            ...
            if (request.getAttribute("userName") != null) {
                out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n +" +
                        ...
                        ">x</span>\n" +
                        " <h5>User '" + request.getAttribute("userName") + "</h5>\n" +
                        "</div>");
            }
        %>
    </div>
